...
class CRG(Module):
    def __init__(self, platform, sys_clk_freq):
        ...
        # No etherbone needed, we have usb_fifo
        # Etherbone --------------------------------------------------------------------------------
...
class SoC(common.RowHammerSoC):
    ...
    def get_platform(self):
        return digilent_nexys_video.Platform(toolchain=self.toolchain) # variant=self.variant, 
    ...
    def add_host_bridge(self):
        self.add_uartbone(name="usb_fifo", baudrate=115200)


        # Use the etherbone for faster tests 
...
def main():
    ...
    parser = common.ArgumentParser(
        description  = "LiteX SoC on nexys_video",
            sys_clk_freq = '100e6',
        module       = 'MT41K256M16',
    )
    g = parser.add_argument_group(title="nexys_video")
